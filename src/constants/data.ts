...
export const news: INews[] = [
  {
    ...
    description: 'Astăzi, 5 Octombrie, împlinim 1 an de prezenta pe piața vinurilor. După 1 an de activitate, avem și rezultate: Prezenta pe piața României Prezenta pe piața Austriei Colaborări în Germania Colaborări in Luxemburg 8 vinuri premium 3 medalii internaționale Dar, cel mai important, ATU Winery și-a găsit atâția prieteni noi, încât nu încap intr-o lista! Va mulțumim ca ați crezut in noi și ne susțineți necondiționat!'
  },
  {
